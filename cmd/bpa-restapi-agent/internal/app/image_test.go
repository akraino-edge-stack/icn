...
func (m *mockValues) GetPath(u *user.User, imageName string) (string, string) {
    args := m.Called(u, "")
...
func (m *mockValues) DBUpdate(k ImageKey, c Image) error {
...
func TestUpdate(t *testing.T) {
    ...
    myMocks.On("DBUnmarshal", arr_data, image).Return(nil)
    myMocks.On("DBUpdate", key, image).Return(nil)
    imageClient := ImageClient{myMocks, "test_image", "test_meta"}
