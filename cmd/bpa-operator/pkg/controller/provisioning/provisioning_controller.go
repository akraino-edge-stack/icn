...
func (r *ReconcileProvisioning) Reconcile(request reconcile.Request) (reconcile.Result, error) {
       ...
       for _, masterMap := range mastersList {
        ...
        //Install KUD
        //kudInstaller(kudInstallerScript, clusterName)
        return reconcile.Result{}, nil
}
...
/*func kudInstaller(kudInstallerPath string, clusterName string) {
      ...
      commands := "./installer.sh --cluster=" + clusterName + "| tee kud_installer.log"
